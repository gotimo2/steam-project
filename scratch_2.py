...
filename = PhotoImage(file="C:\\Users\\Lenovo\\Downloads\\steam image3.png")
...
tree.heading("#6", text="Datum toegevoegd")
...
Button(f2, text='Sorteer games op datum toegevoegd', command=sortByAppid).pack(pady=10)
